...
<nav class="navigation">
    <ul class="main-nav">
        ...
        <li class="main-nav-item"><a href="page_3.php"><p class="nav-text">Мой профиль</p></a></li>
    </ul>
</nav>
<main class="account">
        ...
        <div class="user-actions">
            <h2>Недавние действия</h2>
                <div class="usact">
                    ...
                    <div class="usact-3">
                        <p><?php echo $user_name['name'] ?> оставил комментарий к фильму “Шрек(2001) “Мультфильм на все времена”</p> <p> 02.02.2023 </p>
                    </div>
                </div>
        </div>
    </div>
