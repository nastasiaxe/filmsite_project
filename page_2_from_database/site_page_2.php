...
<nav class="navigation">
    <ul class="main-nav">
        <li class="main-nav-item"><a class="nav-item" href="../page_1/page_1.html"><p class="logo nav-text">MOVIEMINDS <img src="images\pin.png" width="32" height="16"></p></a></li>
...
<section class="main">
    <div class="photo-preview">
        <div class="image-container"><img src="images\preview.jpg" width="250" height="350"></div>
        <p><?php echo $film_title['title'] ?></p>
    </div>
    <div class="discription">
        <div class="name">
            <div class="rate"><p>Рейтинг</p><p>здесь может быть рейтинг</p></div>
            <div><h1><?php  ?></h1></div>
        </div>
        <p class="italic"></p>
        <p><span>Жанр:</span> <?php echo $film_genre['genre'] ?></p>
        <p><span>В главных ролях:</span> здесь могут быть актеры</p>
